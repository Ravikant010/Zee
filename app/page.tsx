  ...
  return (
    <main className="w-full min-h-screen dark:text-gray-300">
      ...
      <div className="relative top-0 flex flex-col items-center justify-center w-full h-full font-[ApfelFett] dark:text-gray-300">
        <h1 className="flex items-center w-full p-2 text-3xl font-semibold text-center h-52 font-[Open Sans] leading-normal  text-center justify-center sm:text-4xl max-w-lg tracking-wide">
          We Provide the Best Customer Experience
        </h1>
        <div className="absolute top-0 bg-gray-800 rounded-full sm:w-72 sm:h-72 w-52 h-52 bg-opacity-45 -z-10 blur-2xl sm:blur-[4rem]"></div>
      </div>
      <div className="relative flex w-full p-4 mx-auto space-x-4 overflow-x-auto xl:justify-center shrink-0 xl:space-x-8">
        {[
          {
      ...
      <div className="w-full my-20 text-2xl font-semibold text-center sm:text-4xl font-[ApfelFett] tracking-wide">
        Find Your Style
      </div>
      ...
      <div className="h-auto my-20 ">
        <h1 className="text-2xl font-semibold text-center font-[ApfelFett] ">
          Our Best Sellers
        </h1>
      ...
      <div className="h-full my-20 ">
        <h1 className="h-full text-2xl font-semibold text-center font-[ApfelFett]">
          New Arrivals
        </h1>
      ...
      <div className="h-auto my-20">
        <h1 className="h-full text-2xl font-semibold text-center">
          Available Brands
        </h1>
      </div>
    </main>
...
function Card({
  ...
  return (
    <div className="relative flex flex-col p-4 my-20 shadow-md w-72 bg-opacity-20 rounded-xl bg-slate-800 shrink-0">
