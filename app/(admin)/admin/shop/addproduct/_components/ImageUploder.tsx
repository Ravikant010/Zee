...
import { DBProductImages } from '../actions/product';
...
const {product_id, handleSetimageuplaodStatus} =   useContextFunction() as ShopIdContextType
...
form_data.append("shop_id", shop?.id as string)
...
console.log(_upload_images.status)
