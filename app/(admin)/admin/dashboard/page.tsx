...
export default function page({}: Props) {
  ...
  async function handleSales() {
    //@ts-ignore
    const { order_price, product_price, percentage, total_products, category , orders_} =
      await total_sales();
  ...
  return (
    <main className="p-2 space-y-2 font-[ApfelFett] tracking-wide text-xl">
      <section className="grid w-full h-32 grid-cols-2 gap-2">
        <div className="flex flex-col justify-around w-full h-full p-2 dark:bg-gray-800 dark:bg-opacity-30 rounded-xl">
        ...
        <div className="w-full h-full p-2 dark:bg-gray-800 dark:bg-opacity-30 rounded-xl">
          <div>
      ...
      <section className="grid w-full grid-cols-2 h-52 dark:bg-gray-800 dark:bg-opacity-30 dark:text-purple-500">
        <div className="flex flex-col w-full h-full p-2 pt-5 rounded-xl">
